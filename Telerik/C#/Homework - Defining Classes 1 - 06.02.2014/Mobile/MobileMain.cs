...
namespace Mobile
{
    // AUTHOR NOTES: I could not be bothered copying the classes over for each and every exercise, so I took the liberty of putting them all into 1 project. Enjoy.
