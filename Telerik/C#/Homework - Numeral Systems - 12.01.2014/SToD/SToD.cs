...
namespace SToD
{
    class SToD
    {
        static void Main()
        {
            Console.Write("Input the numeral system FROM which to convert: ");
            int s = int.Parse(Console.ReadLine());
            Console.Write("Input the numeral system TO which to convert: ");
            int d = int.Parse(Console.ReadLine());
            Console.Write("Input a number in the given numeral system: ");
